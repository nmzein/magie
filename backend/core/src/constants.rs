pub static STORES_PATH: &str = env!("STORES_PATH");
pub static DATABASES_PATH: &str = env!("DATABASES_PATH");
pub static REGISTRY_PATH: &str = concat!(env!("DATABASES_PATH"), "registry.sqlite");
